...
| **作業者** | `worker@example.com` | `Password123` |

管理者アカウントでログインするとダッシュボードが表示され、作業者の位置情報やアラートが確認できます。
作業者アカウントでログインすると、見守り開始・SOS送信などの操作が可能です。（このデモアカウントからは個人情報保護の目的で位置情報等のログは作成できないようにしています）

### ※ご注意

他のお客様も利用されるため、個人名などの入力は避けてください。
